  ...
  return (
    <Card>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-center text-[var(--text-body)]">
          <thead>
            <tr>
                ...
                {FREQUENCY_LABELS.map((f) => {
                  ...
                  return (
                    <td key={f} className="p-2">
                      ...
                      >
                        <span className="tabular-nums text-[var(--text-h2)] font-bold text-[var(--txt-main)]">
                          {cell.count}
                        </span>
                        <span className="text-[var(--text-body)] text-[var(--txt-main)]">clientes</span>
                      </div>
                    </td>
                  )
                })}
